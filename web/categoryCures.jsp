...
<script src="https://js.api.here.com/v3/3.1/mapsjs-service.js"
  ...
  <div class="gallery">
      <a target="_blank" onclick="openModal('Corona Virus Cure','Pictures/stopCoronavirus.jpg')">
        <img src="Pictures/stopCoronavirus.jpg"  id="Masks" alt="Pills" width="600" height="400">
    </a>
    <div class="desc">Corona Virus Cure</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeModal('categoryCures.jsp')">Close</button>
      </div>
    </div>
