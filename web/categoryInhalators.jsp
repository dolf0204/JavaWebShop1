...
<script src="https://js.api.here.com/v3/3.1/mapsjs-service.js"
  ...
  <div class="gallery">
      <a target="_blank" onclick="openModal('CareStar Inhaler Kit','Pictures/CareStarInhalerKit.jpg')">
        <img src="Pictures/CareStarInhalerKit.jpg"  id="Masks" alt="Inhalators" width="600" height="400">
    </a>
    <div class="desc">CareStar Inhaler Kit</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" onclick="openModal('Buoy Type Oxygen Inhalator','Pictures/BuoyTypeOxygenInhalator.jpg')">
      <img src="Pictures/BuoyTypeOxygenInhalator.jpg" id="Masks" alt="Inhalators" width="600" height="400">
    </a>
    <div class="desc">Buoy Type Oxygen Inhalator</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" onclick="openModal('Medline X5 Oxygen Tubing, 5 items','Pictures/MedlineX5OxygenTubing.jpg')">
      <img src="Pictures/MedlineX5OxygenTubing.jpg" id="Masks" alt="Inhalators" width="600" height="400">
    </a>
    <div class="desc">Medline X5 Oxygen Tubing, 5 items</div>
...
<div class="responsive">
  <div class="gallery">
    <a target="_blank" onclick="openModal('Madholly Pollution Face Mask, 4 items','Pictures/MadhollyPollutionFaceMask.jpg')">
        <img src="Pictures/MadhollyPollutionFaceMask.jpg" id="Masks" alt="Inhalators" width="600" height="400">
    </a>
    <div class="desc">Madholly Pollution Face Mask, 4 items</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeModal('categoryInhalators.jsp')">Close</button>
      </div>
    </div>
